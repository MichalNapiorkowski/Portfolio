...
| [Military Mobile Robot for Mine Detection](projects/military-mobile-robot-mine-detection/) | <img src="projects/military-mobile-robot-mine-detection/assets/robot-isometric.png" width="260" alt="Mine detection robot prototype"> | ESP32 web control, camera stream, TMC2209 stepper control, pulse-induction metal detector, 3D-printed chassis |
