...
| --- | --- | --- |
| [Industrial Sorting Machine Prototype](projects/industrial-sorting-machine-prototype/) | <img src="projects/industrial-sorting-machine-prototype/assets/real-station.png" width="260" alt="Sorting machine prototype"> | PLC control, PLCSIM Advanced, HMI, Modbus TCP, ESP32, STM32, Raspberry Pi vision, OpenCV |
| [Military Mobile Robot for Mine Detection](projects/military-mobile-robot-mine-detection/) | <img src="projects/military-mobile-robot-mine-detection/assets/robot-prototype.png" width="200" alt="Mine detection robot prototype"> | ESP32 web control, camera stream, TMC2209 stepper control, pulse-induction metal detector, 3D-printed chassis |
